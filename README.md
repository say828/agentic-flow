...
```bash
/plugin install ship@agentic-dev
/plugin install spec-orchestrator@agentic-dev
/plugin install autonomous-decision-loop@agentic-dev
...
```bash
curl -fsSL https://raw.githubusercontent.com/say828/agentic-dev/main/scripts/install.sh | bash
```

기본 설치 결과:

- Codex skills 설치: `planning-with-files`, `universal-agentic-dev`, `sdd`
...
- `~/.codex/skills/universal-agentic-dev`
- `~/.codex/skills/sdd`
- `~/.local/share/agentic-dev/repo`

Codex ADL 런타임 위치:

- `~/.local/share/agentic-dev/repo/autonomous-decision-loop`
